 ...
 render() {
   return (
    <div>
      <div>
        <h1>Main idea</h1>
        <p>   There are many typing tests out there. Type Master is set apart by the ease of use and the
        ...
        <p>
           Type Master design decisions were chosen based on what we believed would create the most useful and enjoyable
        ...
        <p>
            Type Master allows users to provide log in information. Doing so opens up additional features;
